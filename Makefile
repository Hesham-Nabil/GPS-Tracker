...
#CFLAGS=-ggdb -DSTM32F10XMD_VL -DUSE_STDPERIPH_DRIVER -mthumb -mcpu=cortex-m3
CFLAGS=-ggdb -DNO_SYSTEM_INIT -DSTART=main -nostdlib -mthumb -mcpu=cortex-m4 -mlittle-endian -march=armv7e-m -O2
